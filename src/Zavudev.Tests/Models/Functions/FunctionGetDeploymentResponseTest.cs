...
public class FunctionGetDeploymentResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new FunctionGetDeploymentResponse
        {
            Deployment = new()
            {
                ID = "fnd_abc123",
        ...
        FunctionGetDeploymentResponseDeployment expectedDeployment = new()
        {
            ID = "fnd_abc123",
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
            FunctionID = "functionId",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<FunctionGetDeploymentResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        FunctionGetDeploymentResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class FunctionGetDeploymentResponseDeploymentTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new FunctionGetDeploymentResponseDeployment
        {
            ID = "fnd_abc123",
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
            FunctionID = "functionId",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<FunctionGetDeploymentResponseDeployment>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        FunctionGetDeploymentResponseDeployment copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class FunctionGetDeploymentResponseDeploymentStatusTest : TestBase
{
    [Theory]
    [InlineData(FunctionGetDeploymentResponseDeploymentStatus.Pending)]
    [InlineData(FunctionGetDeploymentResponseDeploymentStatus.Bundling)]
    [InlineData(FunctionGetDeploymentResponseDeploymentStatus.Uploading)]
    [InlineData(FunctionGetDeploymentResponseDeploymentStatus.Publishing)]
    [InlineData(FunctionGetDeploymentResponseDeploymentStatus.Active)]
    [InlineData(FunctionGetDeploymentResponseDeploymentStatus.Failed)]
    [InlineData(FunctionGetDeploymentResponseDeploymentStatus.Superseded)]
    public void Validation_Works(FunctionGetDeploymentResponseDeploymentStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, FunctionGetDeploymentResponseDeploymentStatus> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(FunctionGetDeploymentResponseDeploymentStatus.Failed)]
    [InlineData(FunctionGetDeploymentResponseDeploymentStatus.Superseded)]
    public void SerializationRoundtrip_Works(FunctionGetDeploymentResponseDeploymentStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, FunctionGetDeploymentResponseDeploymentStatus> value = rawValue;
