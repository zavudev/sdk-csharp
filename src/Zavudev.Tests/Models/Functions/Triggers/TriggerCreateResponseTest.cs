...
public class TriggerCreateResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new TriggerCreateResponse
        {
            Added = 0,
            Skipped = 0,
            Triggers =
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<TriggerCreateResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        TriggerCreateResponse copied = new(model);
...
public class TriggerTest : TestBase
{
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Trigger>(json, ModelBase.SerializerOptions);
