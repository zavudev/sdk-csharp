...
public class FunctionRetrieveResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new FunctionRetrieveResponse
        {
            Function = new()
            {
                ID = "fn_abc123",
                ...
                MemoryMB = 256,
                Name = "Order Bot",
                Runtime = FunctionRetrieveResponseFunctionRuntime.Nodejs24,
                Slug = "order-bot",
                Status = FunctionRetrieveResponseFunctionStatus.Draft,
                TimeoutSec = 10,
        ...
        FunctionRetrieveResponseFunction expectedFunction = new()
        {
            ID = "fn_abc123",
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
            Dependencies = new Dictionary<string, string>() { { "openai", "^4.20.0" } },
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<FunctionRetrieveResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        FunctionRetrieveResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class FunctionRetrieveResponseFunctionTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new FunctionRetrieveResponseFunction
        {
            ID = "fn_abc123",
            CreatedAt = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
            Dependencies = new Dictionary<string, string>() { { "openai", "^4.20.0" } },
        ...
        ApiEnum<string, FunctionRetrieveResponseFunctionRuntime> expectedRuntime =
            FunctionRetrieveResponseFunctionRuntime.Nodejs24;
        string expectedSlug = "order-bot";
        ApiEnum<string, FunctionRetrieveResponseFunctionStatus> expectedStatus =
            FunctionRetrieveResponseFunctionStatus.Draft;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<FunctionRetrieveResponseFunction>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        FunctionRetrieveResponseFunction copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class FunctionRetrieveResponseFunctionRuntimeTest : TestBase
{
    [Theory]
    [InlineData(FunctionRetrieveResponseFunctionRuntime.Nodejs24)]
    public void Validation_Works(FunctionRetrieveResponseFunctionRuntime rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, FunctionRetrieveResponseFunctionRuntime> value = rawValue;
        value.Validate();
    }
    ...
    [Theory]
    [InlineData(FunctionRetrieveResponseFunctionRuntime.Nodejs24)]
    public void SerializationRoundtrip_Works(FunctionRetrieveResponseFunctionRuntime rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, FunctionRetrieveResponseFunctionRuntime> value = rawValue;
...
public class FunctionRetrieveResponseFunctionStatusTest : TestBase
{
    [Theory]
    [InlineData(FunctionRetrieveResponseFunctionStatus.Draft)]
    [InlineData(FunctionRetrieveResponseFunctionStatus.Bundling)]
    [InlineData(FunctionRetrieveResponseFunctionStatus.Deploying)]
    [InlineData(FunctionRetrieveResponseFunctionStatus.Active)]
    [InlineData(FunctionRetrieveResponseFunctionStatus.Failed)]
    [InlineData(FunctionRetrieveResponseFunctionStatus.Disabled)]
    public void Validation_Works(FunctionRetrieveResponseFunctionStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, FunctionRetrieveResponseFunctionStatus> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(FunctionRetrieveResponseFunctionStatus.Failed)]
    [InlineData(FunctionRetrieveResponseFunctionStatus.Disabled)]
    public void SerializationRoundtrip_Works(FunctionRetrieveResponseFunctionStatus rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, FunctionRetrieveResponseFunctionStatus> value = rawValue;
