...
public class ChannelUpdateResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ChannelUpdateResponse
        {
            Channel = new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ChannelUpdateResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        ChannelUpdateResponse copied = new(model);
