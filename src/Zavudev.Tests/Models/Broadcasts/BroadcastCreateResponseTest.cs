...
public class BroadcastCreateResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BroadcastCreateResponse
        {
            Broadcast = new()
            {
                ID = "brd_abc123",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BroadcastCreateResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        BroadcastCreateResponse copied = new(model);
