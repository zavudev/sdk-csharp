...
public class BroadcastRetrieveResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BroadcastRetrieveResponse
        {
            Broadcast = new()
            {
                ID = "brd_abc123",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BroadcastRetrieveResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        BroadcastRetrieveResponse copied = new(model);
