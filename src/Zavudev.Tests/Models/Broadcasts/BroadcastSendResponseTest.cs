...
public class BroadcastSendResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BroadcastSendResponse
        {
            Broadcast = new()
            {
                ID = "brd_abc123",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BroadcastSendResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        BroadcastSendResponse copied = new(model);
