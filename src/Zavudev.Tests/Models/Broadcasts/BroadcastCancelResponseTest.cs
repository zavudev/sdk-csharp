...
public class BroadcastCancelResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BroadcastCancelResponse
        {
            Broadcast = new()
            {
                ID = "brd_abc123",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BroadcastCancelResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        BroadcastCancelResponse copied = new(model);
