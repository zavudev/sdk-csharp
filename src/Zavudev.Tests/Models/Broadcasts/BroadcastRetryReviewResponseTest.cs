...
public class BroadcastRetryReviewResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BroadcastRetryReviewResponse
        {
            Broadcast = new()
            {
                ID = "brd_abc123",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BroadcastRetryReviewResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        BroadcastRetryReviewResponse copied = new(model);
