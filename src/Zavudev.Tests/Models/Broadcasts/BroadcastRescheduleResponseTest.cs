...
public class BroadcastRescheduleResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BroadcastRescheduleResponse
        {
            Broadcast = new()
            {
                ID = "brd_abc123",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BroadcastRescheduleResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        BroadcastRescheduleResponse copied = new(model);
