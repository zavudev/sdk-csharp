...
public class BroadcastEscalateReviewResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BroadcastEscalateReviewResponse
        {
            Broadcast = new()
            {
                ID = "brd_abc123",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BroadcastEscalateReviewResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        BroadcastEscalateReviewResponse copied = new(model);
