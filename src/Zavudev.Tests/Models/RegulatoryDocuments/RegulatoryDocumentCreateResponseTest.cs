...
public class RegulatoryDocumentCreateResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new RegulatoryDocumentCreateResponse
        {
            Document = new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<RegulatoryDocumentCreateResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        RegulatoryDocumentCreateResponse copied = new(model);
