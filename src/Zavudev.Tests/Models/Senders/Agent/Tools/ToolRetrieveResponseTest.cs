...
public class ToolRetrieveResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Tools::ToolRetrieveResponse
        {
            Tool = new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<Tools::ToolRetrieveResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        Tools::ToolRetrieveResponse copied = new(model);
