...
public class ToolUpdateResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Tools::ToolUpdateResponse
        {
            Tool = new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<Tools::ToolUpdateResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        Tools::ToolUpdateResponse copied = new(model);
