...
public class ToolTestResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ToolTestResponse
        {
            Run = new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ToolTestResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        ToolTestResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class RunTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Run>(json, ModelBase.SerializerOptions);
    ...
    public void FieldRoundtripThroughSerialization_Works()
    {
        ...
        string element = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<Run>(element, ModelBase.SerializerOptions);
        Assert.NotNull(deserialized);
