...
public class FlowRetrieveResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Flows::FlowRetrieveResponse
        {
            Flow = new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<Flows::FlowRetrieveResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        Flows::FlowRetrieveResponse copied = new(model);
