...
public class FlowUpdateResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Flows::FlowUpdateResponse
        {
            Flow = new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<Flows::FlowUpdateResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        Flows::FlowUpdateResponse copied = new(model);
