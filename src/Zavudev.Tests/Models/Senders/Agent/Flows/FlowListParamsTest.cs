...
public class FlowListParamsTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var parameters = new FlowListParams
        {
            SenderID = "senderId",
            Cursor = "cursor",
            Enabled = true,
    ...
    {
        var parameters = new FlowListParams { SenderID = "senderId" };
    ...
    public void Url_Works()
    {
        ...
        Assert.True(
            TestBase.UrisEqual(
                new Uri(
                    "https://api.zavu.dev/v1/senders/senderId/agent/flows?cursor=cursor&enabled=true&limit=100"
                ),
                url
            )
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        FlowListParams copied = new(parameters);
