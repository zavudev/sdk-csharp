...
public class FlowCreateResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new Flows::FlowCreateResponse
        {
            Flow = new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<Flows::FlowCreateResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        Flows::FlowCreateResponse copied = new(model);
