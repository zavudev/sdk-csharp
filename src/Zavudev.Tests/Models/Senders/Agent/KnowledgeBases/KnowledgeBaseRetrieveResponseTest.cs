...
public class KnowledgeBaseRetrieveResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new KnowledgeBaseRetrieveResponse
        {
            KnowledgeBase = new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<KnowledgeBaseRetrieveResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        KnowledgeBaseRetrieveResponse copied = new(model);
