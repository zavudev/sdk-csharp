...
public class DocumentRetrieveDocumentResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new DocumentRetrieveDocumentResponse
        {
            Document = new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<DocumentRetrieveDocumentResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        DocumentRetrieveDocumentResponse copied = new(model);
