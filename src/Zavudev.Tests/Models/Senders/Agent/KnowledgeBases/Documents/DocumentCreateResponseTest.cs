...
public class DocumentCreateResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new DocumentCreateResponse
        {
            Document = new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<DocumentCreateResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        DocumentCreateResponse copied = new(model);
