...
public class KnowledgeBaseUpdateResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new KnowledgeBaseUpdateResponse
        {
            KnowledgeBase = new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<KnowledgeBaseUpdateResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        KnowledgeBaseUpdateResponse copied = new(model);
