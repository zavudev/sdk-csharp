...
public class SenderUploadProfilePictureResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new SenderUploadProfilePictureResponse
        {
            Profile = new()
            {
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<SenderUploadProfilePictureResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        SenderUploadProfilePictureResponse copied = new(model);
