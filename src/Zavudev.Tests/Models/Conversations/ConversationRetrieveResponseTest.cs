...
public class ConversationRetrieveResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ConversationRetrieveResponse
        {
            Conversation = new()
            {
        ...
        Conversation expectedConversation = new()
        {
            ID = "js723987cyghwqxxaxcf590qd18axd95",
            Channels = ["whatsapp", "sms"],
            ContactIdentifier = "+56912345678",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ConversationRetrieveResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        ConversationRetrieveResponse copied = new(model);
...
public class ConversationTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        ...
        LastMessage expectedLastMessage = new()
        {
            ID = "id",
            At = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
            Channel = MessageChannel.Auto,
        ...
        Whatsapp expectedWhatsapp = new() { Bsuid = "bsuid", Username = "username" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        Conversation copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class LastMessageTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new LastMessage
        {
            ID = "id",
            At = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
            Channel = MessageChannel.Auto,
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<LastMessage>(
            json,
            ModelBase.SerializerOptions
        );
...
public class WhatsappTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var model = new Whatsapp { Bsuid = "bsuid", Username = "username" };
