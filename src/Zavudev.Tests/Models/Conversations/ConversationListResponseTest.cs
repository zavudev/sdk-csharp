...
public class ConversationListResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ConversationListResponse
        {
        ...
        ConversationListResponseLastMessage expectedLastMessage = new()
        {
            ID = "id",
            At = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
            Channel = MessageChannel.Auto,
        ...
        ConversationListResponseGroup expectedGroup = new()
        {
            ID = "id",
            ParticipantCount = 0,
            Subject = "subject",
        ...
        ConversationListResponseWhatsapp expectedWhatsapp = new()
        {
            Bsuid = "bsuid",
            Username = "username",
        };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<ConversationListResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        ConversationListResponse copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class ConversationListResponseLastMessageTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ConversationListResponseLastMessage
        {
            ID = "id",
            At = DateTimeOffset.Parse("2019-12-27T18:11:19.117Z"),
            Channel = MessageChannel.Auto,
        ...
        ApiEnum<string, ConversationListResponseLastMessageDirection> expectedDirection =
            ConversationListResponseLastMessageDirection.Inbound;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ConversationListResponseLastMessage>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void CopyConstructor_Works()
    {
        ...
        ConversationListResponseLastMessage copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class ConversationListResponseLastMessageDirectionTest : TestBase
{
    [Theory]
    [InlineData(ConversationListResponseLastMessageDirection.Inbound)]
    [InlineData(ConversationListResponseLastMessageDirection.Outbound)]
    public void Validation_Works(ConversationListResponseLastMessageDirection rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ConversationListResponseLastMessageDirection> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(ConversationListResponseLastMessageDirection.Inbound)]
    [InlineData(ConversationListResponseLastMessageDirection.Outbound)]
    public void SerializationRoundtrip_Works(ConversationListResponseLastMessageDirection rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, ConversationListResponseLastMessageDirection> value = rawValue;
...
public class ConversationListResponseGroupTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ConversationListResponseGroup
        {
            ID = "id",
            ParticipantCount = 0,
            Subject = "subject",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ConversationListResponseGroup>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void OptionalNonNullablePropertiesUnsetAreNotSet_Works()
    {
        var model = new ConversationListResponseGroup { ID = "id" };
    ...
    public void CopyConstructor_Works()
    {
        ...
        ConversationListResponseGroup copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class ConversationListResponseWhatsappTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new ConversationListResponseWhatsapp { Bsuid = "bsuid", Username = "username" };
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        string json = JsonSerializer.Serialize(model, ModelBase.SerializerOptions);
        var deserialized = JsonSerializer.Deserialize<ConversationListResponseWhatsapp>(
            json,
            ModelBase.SerializerOptions
        );
    ...
    public void OptionalNonNullablePropertiesUnsetAreNotSet_Works()
    {
        var model = new ConversationListResponseWhatsapp { };
    ...
    public void CopyConstructor_Works()
    {
        ...
        ConversationListResponseWhatsapp copied = new(model);
