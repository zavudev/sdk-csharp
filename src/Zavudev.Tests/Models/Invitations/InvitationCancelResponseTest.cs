...
public class InvitationCancelResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new InvitationCancelResponse
        {
            Invitation = new()
            {
                ID = "inv_abc123",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<InvitationCancelResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        InvitationCancelResponse copied = new(model);
