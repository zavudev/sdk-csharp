...
public class AddressCreateResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new AddressCreateResponse
        {
            Address = new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<AddressCreateResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        AddressCreateResponse copied = new(model);
