...
public class CampaignSubmitResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new CampaignSubmitResponse
        {
            Campaign = new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<CampaignSubmitResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        CampaignSubmitResponse copied = new(model);
