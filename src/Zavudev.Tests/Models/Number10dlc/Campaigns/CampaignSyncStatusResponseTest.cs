...
public class CampaignSyncStatusResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new CampaignSyncStatusResponse
        {
            Campaign = new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<CampaignSyncStatusResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        CampaignSyncStatusResponse copied = new(model);
