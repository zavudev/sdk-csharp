...
public class BrandSubmitResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BrandSubmitResponse
        {
            Brand = new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BrandSubmitResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        BrandSubmitResponse copied = new(model);
