...
public class BrandRetrieveResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BrandRetrieveResponse
        {
            Brand = new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BrandRetrieveResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        BrandRetrieveResponse copied = new(model);
