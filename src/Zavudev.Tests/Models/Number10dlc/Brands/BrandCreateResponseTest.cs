...
public class BrandCreateResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BrandCreateResponse
        {
            Brand = new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BrandCreateResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        BrandCreateResponse copied = new(model);
