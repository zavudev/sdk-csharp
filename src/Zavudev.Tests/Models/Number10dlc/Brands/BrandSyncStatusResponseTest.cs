...
public class BrandSyncStatusResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BrandSyncStatusResponse
        {
            Brand = new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BrandSyncStatusResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        BrandSyncStatusResponse copied = new(model);
