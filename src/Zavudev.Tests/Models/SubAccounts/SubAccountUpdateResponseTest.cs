...
public class SubAccountUpdateResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new SubAccountUpdateResponse
        {
            SubAccount = new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<SubAccountUpdateResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        SubAccountUpdateResponse copied = new(model);
