...
public class SubAccountCreateResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new SubAccountCreateResponse
        {
            SubAccount = new()
            {
                ID = "id",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<SubAccountCreateResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        SubAccountCreateResponse copied = new(model);
