...
public class AgentUpdateResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new AgentUpdateResponse
        {
            Agent = new()
            {
                ID = "agent_abc123",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<AgentUpdateResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        AgentUpdateResponse copied = new(model);
