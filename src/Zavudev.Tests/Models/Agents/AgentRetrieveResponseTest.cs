...
public class AgentRetrieveResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new AgentRetrieveResponse
        {
            Agent = new()
            {
                ID = "agent_abc123",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<AgentRetrieveResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        AgentRetrieveResponse copied = new(model);
