...
public class AgentUpdateParamsTest : TestBase
{
    ...
    public void FieldRoundtrip_Works()
    {
        var parameters = new AgentUpdateParams
        {
            ...
            Voice = new()
            {
                ...
                TtsVoiceID = "aria",
                VoicemailAction = AgentUpdateParamsVoiceVoicemailAction.Hangup,
        ...
        ApiEnum<string, Agent::AgentProvider> expectedProvider = Agent::AgentProvider.OpenAI;
        ...
        AgentUpdateParamsVoice expectedVoice = new()
        {
            Enabled = true,
            Greeting = "Hi, thanks for calling Acme. How can I help you today?",
            Greetings = new Dictionary<string, string>()
    ...
    public void OptionalNonNullableParamsUnsetAreNotSet_Works()
    {
        ...
        Assert.False(parameters.RawBodyData.ContainsKey("provider"));
    ...
    public void OptionalNullableParamsSetToNullAreSetToNull_Works()
    {
        ...
        Assert.Null(parameters.MaxTokens);
        Assert.True(parameters.RawBodyData.ContainsKey("maxTokens"));
        Assert.Null(parameters.Temperature);
...
public class AgentUpdateParamsVoiceTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new AgentUpdateParamsVoice
        {
            Enabled = true,
            Greeting = "Hi, thanks for calling Acme. How can I help you today?",
            Greetings = new Dictionary<string, string>()
        ...
        ApiEnum<string, AgentUpdateParamsVoiceVoicemailAction> expectedVoicemailAction =
            AgentUpdateParamsVoiceVoicemailAction.Hangup;
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<AgentUpdateParamsVoice>(
            json,
    ...
    {
        var model = new AgentUpdateParamsVoice { Enabled = true };
    ...
    public void CopyConstructor_Works()
    {
        ...
        AgentUpdateParamsVoice copied = new(model);

        Assert.Equal(model, copied);
    }
}

public class AgentUpdateParamsVoiceVoicemailActionTest : TestBase
{
    [Theory]
    [InlineData(AgentUpdateParamsVoiceVoicemailAction.Hangup)]
    [InlineData(AgentUpdateParamsVoiceVoicemailAction.LeaveMessage)]
    public void Validation_Works(AgentUpdateParamsVoiceVoicemailAction rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, AgentUpdateParamsVoiceVoicemailAction> value = rawValue;
        value.Validate();
    }
    ...
    [InlineData(AgentUpdateParamsVoiceVoicemailAction.Hangup)]
    [InlineData(AgentUpdateParamsVoiceVoicemailAction.LeaveMessage)]
    public void SerializationRoundtrip_Works(AgentUpdateParamsVoiceVoicemailAction rawValue)
    {
        // force implicit conversion because Theory can't do that for us
        ApiEnum<string, AgentUpdateParamsVoiceVoicemailAction> value = rawValue;
