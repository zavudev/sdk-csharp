...
public class SenderConnectResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new SenderConnectResponse
        {
            Agent = new()
            {
                ID = "agent_abc123",
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<SenderConnectResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        SenderConnectResponse copied = new(model);
