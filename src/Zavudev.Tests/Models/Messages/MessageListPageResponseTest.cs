...
public class MessageListPageResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new MessageListPageResponse
        {
            Items =
            [
                new()
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<MessageListPageResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        MessageListPageResponse copied = new(model);
