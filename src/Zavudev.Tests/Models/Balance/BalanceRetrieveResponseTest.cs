...
namespace Zavudev.Tests.Models.Balance;

public class BalanceRetrieveResponseTest : TestBase
{
    [Fact]
    public void FieldRoundtrip_Works()
    {
        var model = new BalanceRetrieveResponse
        {
            Balance = 0,
            Currency = "usd",
            CreditLimit = 0,
    ...
    public void SerializationRoundtrip_Works()
    {
        ...
        var deserialized = JsonSerializer.Deserialize<BalanceRetrieveResponse>(
            json,
    ...
    public void CopyConstructor_Works()
    {
        ...
        BalanceRetrieveResponse copied = new(model);
