...
public abstract record class ParamsBase
{
    ...
    static ParamsBase()
    {
        ...
        var customHeadersEnv = Environment.GetEnvironmentVariable("ZAVUDEV_CUSTOM_HEADERS");
    ...
    static string GetUserAgent() => $"{typeof(ZavudevClient).Name}/C# {GetPackageVersion()}";
    ...
    readonly record struct Runtime1
    {
