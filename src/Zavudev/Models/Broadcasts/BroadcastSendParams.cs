...
///
/// <para>**Verification is required to send, and there are two of them.** The team
/// must have completed both identity verification (KYC) and business verification
/// (KYB); passing one is not enough. Drafts can be created, edited and kept without
/// either. Every send path — dashboard, API and CLI alike — enforces both, returning
