...
{
    public required IReadOnlyList<Contact> Items
    {
        get
        {
            this._rawData.Freeze();
            return this._rawData.GetNotNullStruct<ImmutableArray<Contact>>("items");
        }
        init
        {
...
#pragma warning restore CS8618
    ...
    [SetsRequiredMembers]
    public ContactListPageResponse(IReadOnlyList<Contact> items)
        : this()
    {
        this.Items = items;
    }
