...
/// are the exception: they need the account past the unverified level, see `POST
/// /v1/broadcasts/{broadcastId}/send` - Full reference: https://docs.zavu.dev/concepts/sending-limits</para>
///
