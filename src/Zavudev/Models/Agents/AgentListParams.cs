...
/// <summary>
/// Every agent in the project, newest first — including agents that are not connected
/// to any sender yet, which the sender-scoped routes cannot reach. Each item carries
/// `senderIds`, the senders the agent answers on.
///
