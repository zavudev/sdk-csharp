...
/// </summary>
public record class AgentListVoicesParams : ParamsBase
{
    /// <summary>
    ...
    public AgentListVoicesParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public AgentListVoicesParams(AgentListVoicesParams agentListVoicesParams)
        : base(agentListVoicesParams) { }
...
#pragma warning restore CS8618
    ...
    public static AgentListVoicesParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(AgentListVoicesParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/v1/agents/voices")
        {
