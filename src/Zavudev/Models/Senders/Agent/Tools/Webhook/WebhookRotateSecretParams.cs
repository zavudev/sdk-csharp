...
namespace Zavudev.Models.Senders.Agent.Tools.Webhook;
...
#pragma warning disable CS8618
    [SetsRequiredMembers]
    public WebhookRotateSecretParams(WebhookRotateSecretParams webhookRotateSecretParams)
        : base(webhookRotateSecretParams)
    {
        this.SenderID = webhookRotateSecretParams.SenderID;
        this.ToolID = webhookRotateSecretParams.ToolID;
    }
...
#pragma warning restore CS8618
    ...
    public virtual bool Equals(WebhookRotateSecretParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/')
                + string.Format(
                    "/v1/senders/{0}/agent/tools/{1}/webhook/secret",
                    this.SenderID,
                    this.ToolID
                )
        )
