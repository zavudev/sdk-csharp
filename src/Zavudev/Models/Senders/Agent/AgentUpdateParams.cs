...
public record class AgentUpdateParams : ParamsBase
{
    ...
    /// </summary>
    public ApiEnum<string, AgentProvider>? Provider
    {
        get
        {
            this._rawBodyData.Freeze();
            return this._rawBodyData.GetNullableClass<ApiEnum<string, AgentProvider>>("provider");
        }
        init
        {
            if (value == null)
...
#pragma warning disable CS8618
    ...
    {
        this.SenderID = agentUpdateParams.SenderID;
