...
/// </summary>
public record class DocumentRetrieveDocumentParams : ParamsBase
{
    ...
    public DocumentRetrieveDocumentParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public DocumentRetrieveDocumentParams(
        DocumentRetrieveDocumentParams documentRetrieveDocumentParams
    )
        : base(documentRetrieveDocumentParams)
    {
        this.SenderID = documentRetrieveDocumentParams.SenderID;
        this.KBID = documentRetrieveDocumentParams.KBID;
        this.DocID = documentRetrieveDocumentParams.DocID;
    }
...
#pragma warning restore CS8618
    ...
    public static DocumentRetrieveDocumentParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData,
        string senderID,
        string kbid,
    ...
    public virtual bool Equals(DocumentRetrieveDocumentParams? other)
    {
        if (other == null)
        {
            return false;
