...
/// <summary>
/// Get balance for the API key's team. If the API key belongs to a sub-account, also
/// includes the sub-account's total spending and credit limit.
///
...
#pragma warning restore CS8618
    ...
    {
        return new UriBuilder(options.BaseUrl.ToString().TrimEnd('/') + "/v1/balance")
        {
