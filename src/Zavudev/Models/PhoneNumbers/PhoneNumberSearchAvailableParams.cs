...
/// </summary>
public record class PhoneNumberSearchAvailableParams : ParamsBase
{
    /// <summary>
    ...
    public string? Capabilities
    {
        ...
        {
            this._rawQueryData.Freeze();
            return this._rawQueryData.GetNullableClass<string>("capabilities");
        }
        init
        {
            if (value == null)
            ...
            this._rawQueryData.Set("capabilities", value);
        }
    }
    ...
    public string? Contains
    {
        ...
        {
            this._rawQueryData.Freeze();
            return this._rawQueryData.GetNullableClass<string>("contains");
        }
        init
        {
            if (value == null)
            ...
            this._rawQueryData.Set("contains", value);
        }
    }
    ...
    public PhoneNumberSearchAvailableParams() { }

#pragma warning disable CS8618
    [SetsRequiredMembers]
    public PhoneNumberSearchAvailableParams(
        PhoneNumberSearchAvailableParams phoneNumberSearchAvailableParams
    )
        : base(phoneNumberSearchAvailableParams) { }
...
#pragma warning restore CS8618
    ...
    public static PhoneNumberSearchAvailableParams FromRawUnchecked(
        IReadOnlyDictionary<string, JsonElement> rawHeaderData,
        IReadOnlyDictionary<string, JsonElement> rawQueryData
    )
    {
    ...
    public virtual bool Equals(PhoneNumberSearchAvailableParams? other)
    {
        if (other == null)
        {
            return false;
    ...
    public override Uri Url(ClientOptions options)
    {
        return new UriBuilder(
            options.BaseUrl.ToString().TrimEnd('/') + "/v1/phone-numbers/available"
        )
        {
