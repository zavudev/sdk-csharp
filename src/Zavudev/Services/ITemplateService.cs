...
public interface ITemplateService
{
    ...
    /// that is already approved and whose status therefore never moves. A template
    /// whose category changed but whose status did not is still counted in `updated`.
    /// This is the way to repair templates whose category drifted before you started
    /// listening for `template.status_changed`.</para>
    ///
